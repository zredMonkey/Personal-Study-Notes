...
![image](B6B6C90C61FD4C729DFF64DCB10F88AE)

##### 4.2.1.4 删除索引
向 ES 服务器发 DELETE 请求 ：http://127.0.0.1:9200/shopping
![image](CBEB1B5B2D524A7F9CE76D4F590439EA)
...
```
服务器响应结果如下：
![image](880327C7837E464C9958CB2DE790D01A)
```
{
 "_index"【索引】: "shopping",
 "_type"【类型-文档】: "_doc",
...
![image](792353067D6E4C25A326B975B6C3031E)
...
```
![image](CE03D1B19EA4417EA2B0F67C0B2318D3)
...
```
![image](E5F0DF8C223841578A851A3102A33767)
